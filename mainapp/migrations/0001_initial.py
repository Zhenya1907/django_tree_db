    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(max_length=10, verbose_name="First name"),
                ),
                (
                    "middle_name",
                    models.CharField(max_length=5, verbose_name="Middle name"),
                ),
                (
                    "last_name",
                ...
                (
                    "salary",
                    models.DecimalField(
                        decimal_places=0, default=0, max_digits=6, verbose_name="Salary"
                    ),
                ),
                (
                    "department_id",
